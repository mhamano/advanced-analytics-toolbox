  ...
  return {
    ...
    createCube(app, $scope) {
      ...
      const measures = [
        {
          qDef: {
            qDef: `R.ScriptEvalExStr('${dataType}','library(jsonlite); pca_result<-prcomp(data.frame(${meaList}), center = TRUE, scale = TRUE); json<-toJSON(summary(pca_result)$importance); json;',${params})`,
          },
        },
        {
          qDef: {
